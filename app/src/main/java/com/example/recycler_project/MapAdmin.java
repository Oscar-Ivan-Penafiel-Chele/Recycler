...
import com.example.recycler_project.fragments.AdminMapFragment;
...
public class MapAdmin extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void addLocationMap(View v){
        ...
        String url="https://192.168.43.127/Sentencias/mapAdminAdd.php?idUser="+idUser+"&latitud="+latitud+"&longitud="+longitud;
        ...
        StringRequest respuesta = new StringRequest(
            ...
            Intent intent = new Intent(getApplicationContext(), AdminMapFragment.class);
    ...
    private void addMarket(){
        ...
        sharedPreferences = getSharedPreferences("preferenciaslogin",MODE_PRIVATE);
        idUser = sharedPreferences.getInt("id",0);
        String url= "https://192.168.43.127/Sentencias/mapGetLocation.php?id="+idUser;
