...
public class RegisterProductFragment extends Fragment {
    ...
    public void getPriceForMaterial(){
        ...
        String url ="https://192.168.43.127/Sentencias/Consulta_Material.php?idMaterial="+id;
    ...
    public void registerRecycling(int idUsuario, int idMaterial, double pesoKilo, double precioTotal){
        ...
        String url="https://192.168.43.127/Sentencias/RegistroMaterial.php?idUsuario="+idUsuario+"&idMaterial="+idMaterial+"&idRecicladora="+idLocation+"&descripcionReciclaje="+descriptionMaterial+"&peso="+pesoKilo+"&precioTotal="+precioTotal;
