...
public class ProfileFragment extends Fragment {
    ...
    public void getDataUser(){
        ...
        String url= "https://192.168.43.127/Sentencias/Consulta.php?id="+idUser;
    ...
    public void save (View v){
        ...
        String url="https://192.168.43.127/Sentencias/updateUser.php?id="+idUser+"&name="+name+"&lastName="+apellido+"&email="+correo+"&cellphone="+telefono;
