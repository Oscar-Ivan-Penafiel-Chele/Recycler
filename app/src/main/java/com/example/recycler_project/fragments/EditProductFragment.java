...
public class EditProductFragment extends Fragment {
    ...
    private void getProductById(int id){
        ...
        String url= "https://192.168.43.127/Sentencias/Consulta.php?idProduct="+id;
    ...
    private void editProducts(){
        ...
        String url="https://192.168.43.127/Sentencias/updateUser.php?idProduct="+idProduct+"&descripcion="+descripcion+"&peso="+txt_peso.getText().toString();
    ...
    public void getPriceForMaterial(int idMaterial){
        ...
        String url ="https://192.168.43.127/Sentencias/Consulta_Material.php?idMaterial="+idMaterial;
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, (response)->{
            JSONObject jsonObject = null;
            for(int i=0; i<response.length();i++){
                try {
