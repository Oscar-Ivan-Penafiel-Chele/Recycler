...
public class AdminMapFragment extends Fragment {
    ...
    private void getLocations(){
        ...
        String url= "https://192.168.43.127/Sentencias/mapGetLocation.php?id="+id;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, (response)->{
            ...
            Toast.makeText(getActivity().getApplicationContext(), "No tiene ninguna locación agregada", Toast.LENGTH_SHORT).show();
        }
        );
