...
public class MyViewHolderProduct extends RecyclerView.ViewHolder{
    ...
    public TextView totalRecivePrice, totalReciveTitle;
    ...
    public MyViewHolderProduct(@NonNull @NotNull View itemView) {
        ...
        totalRecivePrice = itemView.findViewById(R.id.totalRecivePrice);
        totalReciveTitle = itemView.findViewById(R.id.totalReciveTitle);
    ...
    private void deleteProduct(View v){
        ...
        String url="https://192.168.43.127/Sentencias/deleteProduct.php?idProduct="+id;
