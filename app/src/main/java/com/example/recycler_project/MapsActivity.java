...
//                Toast.makeText(getApplicationContext(),"Hola",Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng intercia = new LatLng(-2.161337, -79.890239);
        mMap.addMarker(new MarkerOptions().position(intercia).title("INTERCIA S.A."));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(intercia, 13));
    }
