<?php
   ...
   if(isset($nombre) && isset($apellido) && isset($telefono) && isset($correo) && isset($contraseña)){
      if(buscarRepetido($correo,$contraseña,$conexion, $tablename) == 1){
         ...
         $query = "INSERT INTO ". $tablename ."(rol, nombre, apellido, telefono, correo, contrasena ,fecha_peticion , estado_peticion) VALUES ('2', '$nombre', '$apellido', '$telefono', '$correo', '$contraseña', NULL ,'0')";
