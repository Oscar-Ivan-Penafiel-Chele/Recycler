<?php
    ...
    class MapAdminProcess {
        ...
        static public function getLocations($idUser){
            $sql = "SELECT * FROM recicladora_sucursal WHERE estado_direccion = '1' && id_usuario = '$idUser'";
        ...
        static public function addLocation($datos){
            $idUser = $datos['idUser'];
            $latitud = $datos['latitud'];
            $longitud = $datos['longitud'];
