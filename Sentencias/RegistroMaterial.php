<?php
   ...
   if ($idUsuario &&  $idMaterial && $peso && $precioTotal) {
       ...
       $sql ="INSERT INTO reciclado(usuario_id, material_id, fecha_reciclaje, peso_kilogramo, precio_total, estado) VALUES ('$idUsuario', ' $idMaterial', CURRENT_TIMESTAMP, '$peso', '$precioTotal', 1)";
